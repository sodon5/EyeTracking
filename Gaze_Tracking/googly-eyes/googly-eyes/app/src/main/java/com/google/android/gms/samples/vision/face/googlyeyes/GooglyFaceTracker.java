...
class GooglyFaceTracker extends Tracker<Face>
{
    ...
    public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face)
    {
        ...
        PointF mouthPosition = getLandmarkPosition(face, (Landmark.LEFT_MOUTH+Landmark.RIGHT_MOUTH)/2); //입위치
        PointF nosePosition = getLandmarkPosition(face, Landmark.NOSE_BASE); //코 위치
