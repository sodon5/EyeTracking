...

{
    ...
    public static abstract class Graphic
    {
        ...
        public abstract PointF getstoreEyes_L();

        public abstract PointF getstoreEyes_R();
    }
    ...
    //store eyes
      ...
      public PointF getstoreEyes_L()
       {
           Iterator<Graphic> itr = mGraphics.iterator();
           while (itr.hasNext()) // 값이 나올때까지 while문을 돈다
           {
               return itr.next().getstoreEyes_L();
           }
    ...
    public PointF getstoreEyes_R()
    {
        ...
        while (itr.hasNext()) // 값이 나올때까지 while문을 돈다
        {
            return itr.next().getstoreEyes_R();
        }
